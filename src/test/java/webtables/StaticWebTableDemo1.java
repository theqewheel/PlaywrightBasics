...
public class StaticWebTableDemo1 {
...
static Page page;
	...
	public static void main(String[] args) {
		...
		Locator rows = page.locator("table[class='tg'] > tbody > tr");
		
		int rowCount = rows.count();
		System.out.println("Web Table Row Count : " + rowCount);
		
		int colCount = page.locator("table[class='tg'] > tbody > tr > th").count();
		System.out.println("Web Table Column Count : " + colCount);
		
		int cellCount = page.locator("table[class='tg'] > tbody > tr > td").count();
		...
		String cellText = page.locator("table[class='tg'] > tbody > tr:nth-child(2) > td:nth-child(1)").textContent();
