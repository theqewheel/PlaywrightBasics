...
public class ShadowDOMLocatorDemo1 {
...
public static void main(String[] args) {
		...
		//find the iframe inside the shadow root
		FrameLocator frame1 = shadowRoot.frameLocator("iframe[src*='input-box']");
		
		//find the element inside iframe inside the shadow root
		frame1.getByPlaceholder("Current Crush Name").fill("Harry Potter");
		
		//find the iframe inside the iframe1 inside shadow root (nested iframe in shadow dom)
		FrameLocator frame2= frame1.frameLocator("iframe[src*='input-box-copy']");
		
		//find the element inside iframe inside the iframe1 inside the shadow root
		frame2.getByPlaceholder("Destiny").fill("Hogwarts");
