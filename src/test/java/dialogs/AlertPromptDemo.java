...
public class AlertPromptDemo {
	...
	public static void main(String[] args) {
		...
		page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Alert with Textbox").setExact(true))
				.click();
		...
		page.onDialog(dialog -> {
			...
			Assert.assertTrue(dialog.message().contains("Please enter your name"), "Expected Dialog Message: Please enter your name.");
			dialog.accept("Autobot");
			// dialog.dismiss();
		});

		page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName(Pattern.compile("prompt"))).click();
		...
		PlaywrightAssertions.assertThat(page.getByText(Pattern.compile("Hello",Pattern.CASE_INSENSITIVE))).containsText("Autobot");
